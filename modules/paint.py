...
class Paint(QtWidgets.QWidget):
    ...
    def __init__(self, parent, geom, minH, maxH, width, height, tab_name):
        ...
        self.palitra = {
              0:'#ffffff',   1:'#000000',   2:'#ffffff',   3:'#ff0000',   4:'#00ff00',   5:'#0000ff',   6:'#ffff00',   7:'#ff00fd', 
              8:'#00ffff',   9:'#810000',  10:'#008100',  11:'#000081',  12:'#818100',  13:'#810081',  14:'#008181',  15:'#c1c1c1',
             16:'#818181',  17:'#9a9aff',  18:'#9a3066',  19:'#ffffcd',  20:'#cdffff',  21:'#660066',  22:'#ff8181',  23:'#0066cd',
             24:'#cdcdff',  25:'#000081',  26:'#ff00fd',  27:'#ffff00',  28:'#00ffff',  29:'#810081',  30:'#810000',  31:'#008181',
             32:'#0000ff',  33:'#00cdff',  34:'#cdffff',  35:'#cdffcd',  36:'#ffff9a',  37:'#9acdff',  38:'#ff9acd',  39:'#cf9aff',
             40:'#ffcd9a',  41:'#ff0000',  42:'#00ff00',  43:'#0000ff',  44:'#ffff00',  45:'#ff00fd',  46:'#00ffff',  47:'#810000',
             48:'#008100',  49:'#000081',  50:'#818100',  51:'#810081',  52:'#008181',  53:'#c1c1c1',  54:'#818181',  55:'#9a9aff',
             56:'#9a3066',  57:'#ffffcd',  58:'#cdffff',  59:'#660066',  60:'#ff8181',  61:'#0066cd',  62:'#cdcdff',  63:'#000081',
             64:'#ff00fd',  65:'#ffff00',  66:'#00ffff',  67:'#810081',  68:'#810000',  69:'#008181',  70:'#0000ff',  71:'#00cdff',
             72:'#cdffff',  73:'#cdffcd',  74:'#ffff9a',  75:'#9acdff',  76:'#ff9acd',  77:'#cf9aff',  78:'#ffcd9a',  79:'#2f66ff',
             80:'#ffffff',  81:'#ff0000',  82:'#00ff00',  83:'#0000ff',  84:'#ffff00',  85:'#ff00fd',  86:'#00ffff',  87:'#810000',
             88:'#008100',  89:'#000081',  90:'#818100',  91:'#810081',  92:'#008181',  93:'#c1c1c1',  94:'#818181',  95:'#9a9aff',
             96:'#9a3066',  97:'#ffffcd',  98:'#cdffff',  99:'#660066', 100:'#ff8181', 101:'#0066cd', 102:'#cdcdff', 103:'#000081',
            104:'#ff00fd', 105:'#ffff00', 106:'#00ffff', 107:'#810081', 108:'#810000', 109:'#008181', 110:'#0000ff', 111:'#00cdff',
            112:'#cdffff', 113:'#cdffcd', 114:'#ffff9a', 115:'#9acdff', 116:'#ff9acd', 117:'#cf9aff', 118:'#ffcd9a', 119:'#2f66ff',
            120:'#ffffff', 121:'#ff0000', 122:'#00ff00', 123:'#0000ff', 124:'#ffff00', 125:'#ff00fd', 126:'#00ffff', 127:'#810000',
            128:'#008100', 129:'#000081', 130:'#818100', 131:'#810081', 132:'#008181', 133:'#c1c1c1', 134:'#818181', 135:'#9a9aff',
            136:'#9a3066', 137:'#ffffcd', 138:'#cdffff', 139:'#660066', 140:'#ff8181', 141:'#0066cd', 142:'#cdcdff', 143:'#000081',
            144:'#ff00fd', 145:'#ffff00', 146:'#00ffff', 147:'#810081', 148:'#810000', 149:'#008181', 150:'#0000ff', 151:'#00cdff'
        }
    ...
    def drawRectangles(self, qp):
        ...
        for x in range(0, len(self.geom)-3):
            for y in range(0, len(self.geom[x])):
                ...
                color = self.palitra[self.geom[x][y]]
    ...
    def dwarprintFire(self, qp):
        qp.setPen(QColor('Black'))
        qp.setBrush(QColor('White'))
        X = stv.init_combust_point_coord[0]
        Y = stv.init_combust_point_coord[1]
        coef = 4
